...
module Rouge
  module Lexers
    ...
    class Sparrow < RegexLexer
      ...
      mimetypes 'text/x-sparrow', 'application/x-sparrow'
      ...
      state :root do
        ...
        rule %r{\b(case|cond|end|bc|lc|if|unless|try|loop|receive|fn|defmodule|
             ...
             defexception|defguardp?|defstruct|exit|raise|throw|after|rescue|catch|else|pattern|as|reaction|react_to|with:|options:|interval:|seq:|window:|debounce:)\b(?![?!])|
             (?<!\.)\b(do|\-\>)\b}x, Keyword
